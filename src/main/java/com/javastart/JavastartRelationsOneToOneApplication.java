...
public class JavastartRelationsOneToOneApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(JavastartRelationsOneToOneApplication.class, args);
